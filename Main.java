...
public class Main {
    ...
    private void colorReduction() {
        ...
        colorReduction("horse", "png");
    }

    private void colorReduction(String filename, String extension) {
        var start = new Processor("./in/" + filename + "." + extension);
        start.addLayer(image -> image.colorReduction());
        start.saveCurrentLayer("./out/color-reduction-" + filename + ".png");
    }
